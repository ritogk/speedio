...
def main() -> GeoDataFrame:
    ...
    gdf_edges_balance = gdf_edges[gdf_edges["score_corner_balance"] >= 0.5 and gdf_edges['score_building'] >= 0.3].sort_values("score", ascending=False).head(200)
    ...
    gdf_edges_week = gdf_edges[(gdf_edges["score_corner_week"] >= 0.35) & (gdf_edges["road_section_cnt"] >= 16) and gdf_edges['score_building'] >= 0.3].sort_values("score", ascending=False).head(200)
    ...
    gdf_edges_medium = gdf_edges[gdf_edges["score_corner_medium"] >= 0.2 and gdf_edges['score_building'] >= 0.3].sort_values("score", ascending=False).head(200)
    ...
    gdf_edges_strong = gdf_edges[gdf_edges["score_corner_strong"] >= 0.2 and gdf_edges['score_building'] >= 0.3].sort_values("score", ascending=False).head(200)
    ...
    gdf_edges_elevation_unevenness = gdf_edges[gdf_edges["elevation_unevenness_count"] >= 2 and gdf_edges['score_building'] >= 0.3].sort_values("elevation_unevenness_count", ascending=False).head(200)
