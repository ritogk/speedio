...
def slim_touge(t, cur=None, pref_code=None):
    ...
    return {
        ...
        "score_elevation_flat": t.get("score_elevation_flat"),
        "score_elevation_gentle": t.get("score_elevation_gentle"),
        "score_elevation_moderate": t.get("score_elevation_moderate"),
        "score_elevation_steep": t.get("score_elevation_steep"),
        "elevation_section": t.get("elevation_section"),
